...
advanced_pages = {
    ...
    "Live ranking snapshots": predictive_command_center.render_live_ranking,
    "Distilled investor evidence": predictive_command_center.render_distilled,
    ...
    "Manual evidence review": training_quality.render_manual_review,
    ...
    "Historical Market Memory": market_memory.render_advanced,
...
basic_pages = {
    ...
    "Мои акции": investor_cockpit.render,
